$(function() {
    ...
    //申し込みボタン
    //===============================
    $('.koutsuujiko_sub #apply_btn a, .foot_lower_sp .koutsuujiko .apply_btn a, #application_2').anchorControl({
        url:'https://www.au-sonpo.co.jp/pca/popup_mbs.html?sPlan=trafficInjury_kobaiari',
        window_name:"_self",
        camp_cd:true
    });
