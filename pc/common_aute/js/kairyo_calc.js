$(document).ready(function(){
	$('select#day_box').val(3);
	$('select#people_box').val(1);
	$('#honType1').prop("checked",true);

	// 日数選択時および人数選択時の処理
	$('#day_box,#people_box').bind('change', function(){
		$('.initial_display_line').hide();
		$('.changed_display_line').show();
		...
		header_anchor($('#kairyo_mitsumori'),{animate:true});
...
*/
	...
	//契被同一、契被別人の切り替えの際には、３，６，８日の表示を維持
...
function setPremium(){
	...
	var selectDay = $('#day_box').val(); //日数を取得
	...
	if( (selectPeo == 1  ) && ($('#honType1').prop("checked")) ){
		...
		$(".target_title").hide();
		$(".course_betsu").hide();
		$(".paytable_title_betsu").hide();
		$(".paytable_title_hon").show();
		$("#hontype_layer").show();
		$(".course_hon").show();
		$(".course_common").show();
		...
		if($("#changed_display_line").css("display") == "none"){
			$('span.person_number').text( "本人タイプ" );
		}else{
			var printString = type1;
			printString += selectDay;
			printString += '日間';
			$('span.person_number').text( printString );
			
			var dayString = selectDay  + '日間';
			$('span.day_number').text( dayString );
		}
	//本人タイプ（契被別人）
		...
		$(".target_title").hide();
		$(".course_hon").hide();
		$(".paytable_title_hon").hide();
		$(".paytable_title_betsu").show();
		$("#hontype_layer").show();
		$(".course_betsu").show();
		$(".course_common").show();
		...
		// 保険タイプ文字列表示(右部)を「家族タイプ x人 x日間」にする
...
function calculate(){
	...
	if( ($('#people_box').val() == 1  ) && !($('#honType1').prop("checked")) ){
		$('#t_i3_br').html( price[arrayN][2][3].slice(0, -1) + "円" );
		$('#t_i3_si').html( price[arrayN][2][4].slice(0, -1) + "円" );
		$('#t_i3_go').html( price[arrayN][2][5].slice(0, -1) + "円" );

		$('#t_i6_br').html( price[arrayN][5][3].slice(0, -1) + "円" );
		$('#t_i6_si').html( price[arrayN][5][4].slice(0, -1) + "円" );
		$('#t_i6_go').html( price[arrayN][5][5].slice(0, -1) + "円" );

		$('#t_i8_br').html( price[arrayN][7][3].slice(0, -1) + "円" );
		$('#t_i8_sl').html( price[arrayN][7][4].slice(0, -1) + "円" );
		$('#t_i8_go').html( price[arrayN][7][5].slice(0, -1) + "円" );

		$('#t_c_br').html( price[arrayN][arrayV][3].slice(0, -1) + "円" );
		$('#t_c_si').html( price[arrayN][arrayV][4].slice(0, -1) + "円" );
		$('#t_c_go').html( price[arrayN][arrayV][5].slice(0, -1) + "円" );

	}else{

		$('#t_i3_br').html( price[arrayN][2][0].slice(0, -1) + "円" );
		$('#t_i3_si').html( price[arrayN][2][1].slice(0, -1) + "円" );
		$('#t_i3_go').html( price[arrayN][2][2].slice(0, -1) + "円" );

		$('#t_i6_br').html( price[arrayN][5][0].slice(0, -1) + "円" );
		$('#t_i6_si').html( price[arrayN][5][1].slice(0, -1) + "円" );
		$('#t_i6_go').html( price[arrayN][5][2].slice(0, -1) + "円" );

		$('#t_i8_br').html( price[arrayN][7][0].slice(0, -1) + "円" );
		$('#t_i8_sl').html( price[arrayN][7][1].slice(0, -1) + "円" );
		$('#t_i8_go').html( price[arrayN][7][2].slice(0, -1) + "円" );

		$('#t_c_br').html( price[arrayN][arrayV][0].slice(0, -1) + "円" );
		$('#t_c_si').html( price[arrayN][arrayV][1].slice(0, -1) + "円" );
		$('#t_c_go').html( price[arrayN][arrayV][2].slice(0, -1) + "円" );
	}
}
