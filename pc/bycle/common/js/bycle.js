$(function() {
    ...
    //申し込みボタン
    //===============================
    $('.apply_bicycle , .bycle_sub #apply_btn a, .foot_lower_sp .bycle .apply_btn a, #application_2').anchorControl({
        url:'https://www.au-sonpo.co.jp/pca/popup_mbs.html?sPlan=bicycle_2017_kobaiari&urlType=bycle',
        window_name:"_self",
        camp_cd:true
    });
